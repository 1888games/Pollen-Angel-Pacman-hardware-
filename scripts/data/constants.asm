...
start_wing_speed:		equ 3
gravity_force:			equ 5
CONTROL_EFFECT:  EQU 12
CONTROL_BRAKE:	 EQU 8
start_lives:		equ 3
start_flower_time:	equ 150
start_flowers:		equ 6
...
v1_volume:       equ         $5055
v1_waveform:       equ         $5045
v1_freq2:       equ         $5052


v2_volume:       equ         $505A
v2_waveform:       equ         $504A
v2_freq2:       equ         $5057

v3_volume:       equ         $505F
v3_waveform:       equ         $504F
v3_freq2:       equ         $505B
...
tile_platform:				equ $25

tile_spikes_start:			equ $28

tile_spikes_down:			equ tile_spikes_start + 1
tile_spikes_up:				equ tile_spikes_start
tile_spikes_right:			equ tile_spikes_start + 3
tile_spikes_left:			equ tile_spikes_start + 2

tile_stem:					equ $26
tile_flower:				equ $27
tile_stem_wilt:				equ $2C
tile_flower_wilt:			equ $2D
tile_flower_eaten:			equ $2F

;spikes_colour:				equ palette_blue_red_yellow
spikes_colour:				equ palette_white_blue_pink
stem_colour:				equ palette_dgreen_green_white
...
wasp_target_2				equ 3
wasp_speed					equ 4
wasp_direction				equ 5
wasp_frac 					equ 6
wasp_base_frame			equ 7
