...
show_lives:
                ...
                ld hl,lives_location                                               ;vram address to write to
                dec hl
                ld a,(player_lives)                                                ;get game time
                                                                               ;byte needs to be in c
                ld (hl), a 
               ...
               // call show_hex                                                        ;use hex display as this is a bcd number (so it just works)
                ...
                ld hl,level_location                                                ;vram address to write to
                ld a,(current_level)   
                add 1                                             ;get game time
                ld c,a                                                                        ;byte needs to be in c
                call show_hex

                ld hl,flowers_location - 1                                               ;vram address to write to
                ld a,(flowers_to_go)
                ld (hl), a  
